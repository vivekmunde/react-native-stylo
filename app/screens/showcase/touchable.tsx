    ...
    <ScreenBody>
      <React.Fragment>
        ...
        <Stylish.TouchableOpacity
          ...
          <Stylish.Text>
            {
              'The Touchable styles can be used for <TouchableOpacity />, <TouchableHighlight /> & <Pressable /> components.'
            }
          </Stylish.Text>
          <Stylish.View
            styleNames={[
            ...
            <Stylish.Icon.AntDesign
              name="right"
              styleNames={['Color.Primary', 'Margin.Left.Small']}
            />
          </Stylish.View>
        </Stylish.TouchableOpacity>
        ...
        <Stylish.View styleNames={['Flex.Row', 'Margin.Bottom.Large']}>
          <Stylish.TouchableOpacity
            styleNames={['Avatar.Jacket', 'Margin.Right']}>
            <Stylish.Image
              source={require('../../images/face-icon-2.png')}
              styleNames={['Avatar']}
            />
          ...
          <Stylish.TouchableOpacity
            styleNames={['Badge', 'BackgroundColor.Primary', 'Margin.Right']}>
