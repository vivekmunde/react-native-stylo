...
declare const Stylo: {
    ...
    SafeAreaViewStyles: <TStyleName_3 extends string, TStyleNamespace_3 extends string>({ styleNamespace, styleNames, children, }: {
        styleNamespace?: TStyleNamespace_3 | undefined;
        styleNames: TStyleName_3[];
        children: (style: import("react-native").StyleProp<import("react-native").ViewStyle>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    }) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    ScrollViewStyles: <TStyleName_4 extends string, TStyleNamespace_4 extends string>({ styleNamespace, styleNames, children, }: {
        styleNamespace?: TStyleNamespace_4 | undefined;
        styleNames: TStyleName_4[];
        children: (style: import("react-native").StyleProp<import("react-native").ViewStyle>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    }) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    ScrollViewContentContainerStyles: <TStyleName_5 extends string, TStyleNamespace_5 extends string>({ styleNamespace, styleNames, children, }: {
        styleNamespace?: TStyleNamespace_5 | undefined;
        styleNames: TStyleName_5[];
        children: (style: import("react-native").StyleProp<import("react-native").ViewStyle>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    }) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    Styles: <TStyleProp, TStyleName_6 extends string, TStyleNamespace_6 extends string>({ styleNamespace, styleNames, children, }: {
        styleNamespace: TStyleNamespace_6;
        styleNames: TStyleName_6[];
        children: (style: import("react-native").StyleProp<TStyleProp>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    }) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    TextStyles: <TStyleName_7 extends string, TStyleNamespace_7 extends string>({ styleNamespace, styleNames, children, }: {
        styleNamespace?: TStyleNamespace_7 | undefined;
        styleNames: TStyleName_7[];
        children: (style: import("react-native").StyleProp<import("react-native").TextStyle>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    }) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    TextInputStyles: <TStyleName_8 extends string, TStyleNamespace_8 extends string>({ styleNamespace, styleNames, children, }: {
    ...
    TouchableStyles: <TStyleName_9 extends string, TStyleNamespace_9 extends string>({ styleNamespace, styleNames, children, }: {
    ...
    ViewStyles: <TStyleName_10 extends string, TStyleNamespace_10 extends string>({ styleNamespace, styleNames, children, }: {
        styleNamespace?: TStyleNamespace_10 | undefined;
        styleNames: TStyleName_10[];
        children: (style: import("react-native").StyleProp<import("react-native").ViewStyle>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    }) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null;
    Icon: typeof _Icon;
    Image: <TStyleName_11 extends string, TStyleNamespace_11 extends string>({ styleNamespace, styleNames, style, ...props }: _ImageProps<TStyleName_11, TStyleNamespace_11>) => JSX.Element;
    ImageBackground: <TStyleName_12 extends string, TStyleNamespace_12 extends string>({ styleNamespace, styleNames, style, ...props }: _ImageBackgroundProps<TStyleName_12, TStyleNamespace_12>) => JSX.Element;
    Pressable: <TStyleName_13 extends string, TStyleNamespace_13 extends string>({ styleNamespace, styleNames, style, ...props }: _PressableProps<TStyleName_13, TStyleNamespace_13>) => JSX.Element;
    SafeAreaView: <TStyleName_14 extends string, TStyleNamespace_14 extends string>({ styleNamespace, styleNames, style, ...props }: _SafeAreaViewProps<TStyleName_14, TStyleNamespace_14>) => JSX.Element;
    ScrollView: <TScrollViewStyle extends string, TScrollViewStyleNamespace extends string, TScrollViewContentContainerStyle extends string, TScrollViewContentContainerStyleNamespace extends string>({ styleNamespace, styleNames, style, contentContainerStyleNamespace, contentContainerStyleNames, contentContainerStyle, ...props }: _ScrollViewProps<TScrollViewStyle, TScrollViewStyleNamespace, TScrollViewContentContainerStyle, TScrollViewContentContainerStyleNamespace>) => JSX.Element;
    Text: <TStyleName_15 extends string, TStyleNamespace_15 extends string>({ styleNamespace, styleNames, style, ...props }: _TextProps<TStyleName_15, TStyleNamespace_15>) => JSX.Element;
    TextInput: <TStyleName_16 extends string, TStyleNamespace_16 extends string>({ styleNamespace, styleNames, style, ...props }: _TextInputProps<TStyleName_16, TStyleNamespace_16>) => JSX.Element;
    TouchableHighlight: <TStyleName_17 extends string, TStyleNamespace_17 extends string>({ styleNamespace, styleNames, style, ...props }: _TouchableHighlightProps<TStyleName_17, TStyleNamespace_17>) => JSX.Element;
    TouchableOpacity: <TStyleName_18 extends string, TStyleNamespace_18 extends string>({ styleNamespace, styleNames, style, ...props }: _TouchableOpacityProps<TStyleName_18, TStyleNamespace_18>) => JSX.Element;
    View: <TStyleName_19 extends string, TStyleNamespace_19 extends string>({ styleNamespace, styleNames, style, ...props }: _ViewProps<TStyleName_19, TStyleNamespace_19>) => JSX.Element;
};
