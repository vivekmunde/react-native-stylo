...
var ScrollViewStyles = function (_a) {
    ...
    var style = (0, use_scroll_view_styles_1.useScrollViewStyles)(styleNames, styleNamespace);
    return children(style);
};
exports.ScrollViewStyles = ScrollViewStyles;
var ScrollViewContentContainerStyles = function (_a) {
    var styleNamespace = _a.styleNamespace, styleNames = _a.styleNames, children = _a.children;
    var style = (0, use_scroll_view_styles_1.useScrollViewContentContainerStyles)(styleNames, styleNamespace);
    return children(style);
};
