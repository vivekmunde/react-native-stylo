...
exports.TouchableOpacity = exports.TouchableHighlight = exports.Pressable = void 0;
...
var Pressable = function (_a) {
    ...
    var viewStyle = (0, stylers_1.useTouchableStyles)(styleNames !== null && styleNames !== void 0 ? styleNames : [], styleNamespace !== null && styleNamespace !== void 0 ? styleNamespace : 'TouchableStyles');
    var pressableFunctionStyle = typeof style === 'function'
        ? function (args) { return style(args); }
        : undefined;
    return (<react_native_1.Pressable {...props} style={[
            viewStyle,
...
var TouchableHighlight = function (_a) {
    var styleNamespace = _a.styleNamespace, styleNames = _a.styleNames, style = _a.style, props = __rest(_a, ["styleNamespace", "styleNames", "style"]);
    var viewStyle = (0, stylers_1.useTouchableStyles)(styleNames !== null && styleNames !== void 0 ? styleNames : [], styleNamespace !== null && styleNamespace !== void 0 ? styleNamespace : 'TouchableStyles');
    return <react_native_1.TouchableHighlight {...props} style={[viewStyle, style]}/>;
};
exports.TouchableHighlight = TouchableHighlight;
var TouchableOpacity = function (_a) {
    var styleNamespace = _a.styleNamespace, styleNames = _a.styleNames, style = _a.style, props = __rest(_a, ["styleNamespace", "styleNames", "style"]);
    var viewStyle = (0, stylers_1.useTouchableStyles)(styleNames !== null && styleNames !== void 0 ? styleNames : [], styleNamespace !== null && styleNamespace !== void 0 ? styleNamespace : 'TouchableStyles');
    return <react_native_1.TouchableOpacity {...props} style={[viewStyle, style]}/>;
};
